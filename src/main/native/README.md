...
ABI 5 identifies this Minecraft 26.2 backport and rejects the 26.3/ABI 4
binaries. All generation and structure-placement calls select `MC_26_2`.
Abandoned Camps and Dappled Forest are unsupported and excluded from the
structure and biome pickers. Primitive function signatures and the six-int
result stride remain unchanged.
Generation comes from Seed Atlas commit
`30f024b724aca816b7ccd4ada640ccb22125ff60`, downloaded and SHA-256 verified
